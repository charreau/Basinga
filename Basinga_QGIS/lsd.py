# -*- coding: utf-8 -*-
# Lucas Szafran and Julien Charreau 2018
...
def load_consts():
    ...
    path= os.path.dirname(os.path.realpath(__file__)) + '/consts_py.mat'
...
def ERA40atm(site_lat, site_lon, site_elv):
    ...
    from parameters_definition import ERA40_lat, ERA40_lon, ERA40_meanP, ERA40_meanT
...
def LSDv9(lat,lon,alt,atm,age,w,nuclide,Paleomag):
    ...
    from parameters_definition import MUSCHELERm
